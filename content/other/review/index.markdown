...
I reviewed my first paper for a journal in 2012, and since then I have reviewed  177 submissions for 56 different journals. That works out as about 13 reviews per year since I started reviewing, 18.1 per year in the last five years, and 31 in the last 12 months. I've also reviewed seven book proposals for four different publishers, and ten grant proposals for four different funding bodies, and sat on an ESRC Grant Assessment Panel.  
