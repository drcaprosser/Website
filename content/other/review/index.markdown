...
I reviewed my first paper for a journal in 2012, and since then I have reviewed  180 submissions for 56 different journals. That works out as about 13.1 reviews per year since I started reviewing, 18.1 per year in the last five years, and 30 in the last 12 months. I've also reviewed seven book proposals for four different publishers, 11 grant proposals for four different funding bodies, and have sat on one ESRC Grant Assessment Panel.  
